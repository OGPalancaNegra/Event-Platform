...
import kotlinx.android.synthetic.main.activity_eg_login.login_button
import kotlinx.android.synthetic.main.activity_eo_login.*

class eoLogin: AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_eo_login)


        val unregisteredTxt = findViewById<TextView>(R.id.txt_unregistered)

        unregisteredTxt.setOnClickListener {
            startActivity(Intent(this, eoRegistration::class.java))
            finish()
        }


        event_goer_text_view.setOnClickListener {
